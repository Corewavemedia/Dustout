                      ...
                      >
                        ...
                        {formData.selectedServices.length > 0 && (
                          <div className="space-y-4">
                            <h3 className="text-white font-majer text-sm mb-2">
                              Service Details
                            </h3>
                    ...
                    {currentStep === 3 && (
                      ...
                      >
                        <div className="text-center mb-6">
                          <h3 className="text-white font-majer text-2xl mb-2">
                            Order Summary
                          </h3>
                          ...
                          <div className="space-y-2">
                            {formData.selectedServices.map(
                              (selectedService, index) => {
                                ...
                                const serviceTotal =
                                  selectedService.variables.reduce(
                                    (total, variable) => {
                                      ...
                                      (variable) => {
                                        ...
                                        return (
                                          <div
                                            ...
                                            className="flex justify-between items-center text-blue-200 text-sm ml-4"
                                          >
                                            <span>
                                ...
                                {formData.selectedServices
                                  .reduce((total, selectedService) => {
                                    ...
                                    return (
                                      total +
                                      selectedService.variables.reduce(
                                        (serviceTotal, variable) => {
                                          const serviceVariable =
                                            service.variables?.find(
                                              (v) =>
                                                v.id === variable.variableId
                                            );
                                          return (
                                            serviceTotal +
                                            (serviceVariable
                                ...
                                {(
                                  formData.selectedServices.reduce(
                                    (total, selectedService) => {
                                      const service = services.find(
                                        (s) =>
                                          s.id === selectedService.serviceId
                                      );
                                      if (!service) return total;
                                  ...
                                  (formData.serviceFrequency === "Weekly"
                                    ? 4
                                    : formData.serviceFrequency === "Bi-weekly"
                                    ? 2
                                    : formData.serviceFrequency === "Monthly"
                                    ? 12
                                    : 1)
                                ).toFixed(2)}
                              </span>
