            ...
            <div className="hidden md:flex md:w-5/12 bg-blue-500 p-12 relative flex-col justify-center">
              ...
              >
                ...
                <div className="flex justify-center mt-6 space-x-3">
                  <div className={`w-4 h-4 rounded-full ${currentStep === 1 ? 'bg-white' : 'bg-blue-300'}`}></div>
                  <div className={`w-4 h-4 rounded-full ${currentStep === 2 ? 'bg-white' : 'bg-blue-300'}`}></div>
                </div>
              </motion.div>
              ...
              <form onSubmit={handleSubmit} className="min-h-[600px]">
                <AnimatePresence mode="wait">
                  {currentStep === 1 && (
                    ...
                    >
                      <div>
                        <label htmlFor="fullName" className="block text-white font-majer text-sm mb-1">Full Name *</label>
                        <input
                          type="text"
                          id="fullName"
                          name="fullName"
                      ...
                      <div>
                        <label htmlFor="serviceAddress" className="block text-white font-majer text-sm mb-1">Service Address *</label>
                        <input
                          type="text"
                          id="serviceAddress"
                          name="serviceAddress"
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label htmlFor="cityState" className="block text-white font-majer text-sm mb-1">City/State</label>
                          <input
                            type="text"
                            id="cityState"
                            name="cityState"
                        ...
                        <div>
                          <label htmlFor="postCode" className="block text-white font-majer text-sm mb-1">Post Code</label>
                          <input
                            type="text"
                            id="postCode"
                            name="postCode"
                      ...
                      <div>
                        <label htmlFor="landmark" className="block text-white font-majer text-sm mb-1">Landmark or Special Directions</label>
                        <input
                          type="text"
                          id="landmark"
                          name="landmark"
                  ...
                  {currentStep === 2 && (
                    ...
                    >
                      <div>
                        <label className="block text-white font-majer text-sm mb-2">Type of Service *</label>
                        <div className="grid grid-cols-2 gap-2">
                          {['Home Cleaning', 'Office Cleaning', 'Deep Cleaning', 'Post-Construction', 'Move-In/Move-Out', 'Carpet/Upholstery Cleaning'].map((service) => (
                            <label key={service} className="flex items-center text-white text-sm">
                              <input
                                type="checkbox"
                                name="serviceTypes"
                                value={service}
                      ...
                      <div>
                        <label className="block text-white font-majer text-sm mb-2">Service Frequency *</label>
                        <div className="grid grid-cols-2 gap-2">
                          {['One-time', 'Weekly', 'Bi-weekly', 'Monthly'].map((frequency) => (
                            <label key={frequency} className="flex items-center text-white text-sm">
                              <input
                                type="radio"
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label htmlFor="bedrooms" className="block text-white font-majer text-sm mb-1">No. of Bedrooms</label>
                          <input
                            type="number"
                            id="bedrooms"
                            name="bedrooms"
                        ...
                        <div>
                          <label htmlFor="bathrooms" className="block text-white font-majer text-sm mb-1">No. of Bathrooms</label>
                          <input
                            type="number"
                            id="bathrooms"
                            name="bathrooms"
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label htmlFor="preferredDate" className="block text-white font-majer text-sm mb-1">Preferred Date</label>
                          <input
                            type="date"
                            id="preferredDate"
                            name="preferredDate"
                        ...
                        <div>
                          <label htmlFor="preferredTime" className="block text-white font-majer text-sm mb-1">Preferred Time Slot</label>
                          <select
                            id="preferredTime"
                            name="preferredTime"
                      ...
                      <div>
                        <label className="block text-white font-majer text-sm mb-2">Is this an urgent request?</label>
                      ...
                      <div>
                        <label htmlFor="specialNotes" className="block text-white font-majer text-sm mb-1">Anything we should know before arriving?</label>
                        <textarea
                          id="specialNotes"
                          name="specialNotes"
