...
const SignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('https://app.dustout.co.uk/api/register.php', {
        method: 'POST',
        headers: {
        ...
        >
          ...
          <div className="bg-blue-500 rounded-3xl p-8 shadow-2xl">
            <div className="text-center mb-8">
              <h2 className="text-4xl font-bold font-majer text-white mb-2">Sign Up</h2>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label htmlFor="username" className="block text-white text-sm font-majer font-medium mb-2">
                  Username *
                </label>
                <input
                  type="text"
            ...
            <div className="mt-8 text-center">
              <p className="text-blue-100">
                ...
                <Link href="/signin" className="text-white hover:text-blue-200 font-medium underline transition duration-200">
                  Sign In
                </Link>
              </p>
            </div>
