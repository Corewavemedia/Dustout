         ...
         <div className="hidden md:grid md:grid-cols-2 gap-8 items-start">
           ...
           >
             <div className="sticky top-20">
               <h1 className="text-green-500 text-3xl font-bold font-majer">About Us</h1>
               <h2 className="text-4xl md:text-5xl font-bold text-blue-600 mb-6 font-majer">
                 Best Cleaning in The UK
               </h2>
 
               <p className="text-[#777777] mb-8 leading-relaxed font-semibold">
                 At DustOut, we are the UK&apos;s top cleaning agency, specializing in
                 industrial cleaning, residential cleaning, fumigation, and
                 landscaping.
                 <br />
